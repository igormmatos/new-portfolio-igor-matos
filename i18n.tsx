...
export const translations = {
  'pt-BR': {
    ...
    'nav.contact': 'Contato',
    'nav.admin': 'Admin',
    'nav.admin_access': 'Acesso administrativo',
    'nav.back': 'Voltar ao Site',
    'nav.view_original': 'Ver original',
    'demo.view_cta': 'Ver demonstração',
    'demo.preview_home_cta': 'Ver alterações na tela inicial',
    'demo.session_timeout': 'Sessão de demonstração encerrada por inatividade.',
    'demo.preview_badge': 'Demonstração',
    'demo.end_session': 'Encerrar demonstração',
  ...
  'en': {
    ...
    'nav.view_original': 'View original',
    'demo.view_cta': 'View demo',
    'demo.preview_home_cta': 'View changes on home screen',
    'demo.session_timeout': 'Demo session ended due to inactivity.',
    'demo.preview_badge': 'Demonstração',
    'demo.end_session': 'End demo',
  ...
  'fr': {
    ...
    'nav.contact': 'Contact',
    'nav.admin': 'Admin',
    'nav.admin_access': 'Accès administrateur',
    'nav.back': 'Retour au site',
    'nav.view_original': 'Voir original',
    'demo.view_cta': 'Voir démonstration',
    'demo.preview_home_cta': 'Voir les changements sur l\'écran d\'accueil',
    'demo.session_timeout': 'La session de démonstration a été terminée pour inactivité.',
    'demo.preview_badge': 'Demonstração',
    'demo.end_session': 'Terminer la démonstration',
